...
MODELS = {
    ...
    'model-026': {'name': 'Black Forest Labs: FLUX.1 Kontext [pro]', 'filename': 'flux1-kontext-pro', 'open_source': False},
    ...
    'model-030': {'name': 'Alibaba: Qwen-Image', 'filename': 'qwen-image', 'open_source': True},
    'model-031': {'name': 'Google: Gemini 2.5 Flash Image Preview', 'filename': 'gemini25flashimagepreview', 'open_source': False},
    ...
    'model-061': {'name': 'Google: Nano Banana 2 4k', 'filename': 'nanobanana-2-4k', 'open_source': False},
}
